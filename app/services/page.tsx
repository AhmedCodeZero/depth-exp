...
export default function ServicesPage() {
  ...
  const services = [
    {
      icon: Users,
      data: currentContent.services.consulting,
      gradient: "from-[#4a90a4] to-[#6bb6c7]",
    },
    {
      icon: Target,
      data: currentContent.services.strategy,
      gradient: "from-[#1e3a5f] to-[#4a90a4]",
    },
    {
      icon: TrendingUp,
      data: currentContent.services.digital,
      gradient: "from-[#6bb6c7] to-[#4a90a4]",
    },
    {
      icon: Award,
      data: currentContent.services.training,
      gradient: "from-[#4a90a4] to-[#1e3a5f]",
    },
  ]
