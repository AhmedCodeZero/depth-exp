      ...
      <section id="services" className="py-20 bg-gradient-to-br from-background via-muted/30 to-background relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center service-card-hover border-[#4a90a4]/20 bg-gradient-to-br from-white to-blue-50/50 relative overflow-hidden">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.services.consulting.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.services.consulting.description}
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center service-card-hover border-[#4a90a4]/20 bg-gradient-to-br from-white to-blue-50/50 relative overflow-hidden">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.services.strategy.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.services.strategy.description}
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center service-card-hover border-[#4a90a4]/20 bg-gradient-to-br from-white to-blue-50/50 relative overflow-hidden">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.services.digital.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.services.digital.description}
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center service-card-hover border-[#4a90a4]/20 bg-gradient-to-br from-white to-blue-50/50 relative overflow-hidden">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.services.training.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.services.training.description}
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="cases" className="py-20 bg-gradient-to-br from-[#1e3a5f]/5 via-[#4a90a4]/5 to-[#6bb6c7]/5 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <Card className="overflow-hidden card-glow border-[#4a90a4]/20 bg-white relative">
              <div className="h-48 bg-gradient-to-br from-[#4a90a4]/20 to-[#6bb6c7]/30 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent animate-pulse"></div>
              </div>
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <Badge className="bg-gradient-to-r from-[#4a90a4] to-[#6bb6c7] text-white border-0">
                    {currentContent.cases.case1.result}
                  </Badge>
                </div>
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.cases.case1.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.cases.case1.description}
                </CardDescription>
              </CardContent>
            </Card>

            <Card className="overflow-hidden card-glow border-[#4a90a4]/20 bg-white relative">
              <div className="h-48 bg-gradient-to-br from-[#6bb6c7]/20 to-[#4a90a4]/30 relative overflow-hidden">
                <div
              ...
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <Badge className="bg-gradient-to-r from-[#4a90a4] to-[#6bb6c7] text-white border-0">
                    {currentContent.cases.case2.result}
                  </Badge>
                </div>
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.cases.case2.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.cases.case2.description}
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="blog" className="py-20 bg-gradient-to-br from-background via-muted/20 to-background relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="card-glow border-[#4a90a4]/20 bg-white overflow-hidden relative">
              <div className="h-48 bg-gradient-to-br from-[#1e3a5f]/10 to-[#4a90a4]/20 relative">
                <div className="absolute top-4 right-4 w-12 h-12 bg-gradient-to-br from-[#4a90a4] to-[#6bb6c7] rounded-full opacity-20"></div>
                <div className="absolute bottom-4 left-4 w-8 h-8 bg-gradient-to-br from-[#6bb6c7] to-[#4a90a4] rounded-full opacity-30"></div>
              </div>
              <CardHeader>
                <div className="text-sm text-[#4a90a4] font-medium mb-2">{currentContent.blog.post1.date}</div>
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.blog.post1.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.blog.post1.excerpt}
                </CardDescription>
              </CardContent>
            </Card>

            <Card className="card-glow border-[#4a90a4]/20 bg-white overflow-hidden relative">
              <div className="h-48 bg-gradient-to-br from-[#4a90a4]/10 to-[#6bb6c7]/20 relative">
                <div className="absolute top-4 left-4 w-10 h-10 bg-gradient-to-br from-[#6bb6c7] to-[#4a90a4] rounded-full opacity-25"></div>
                <div className="absolute bottom-4 right-4 w-6 h-6 bg-gradient-to-br from-[#4a90a4] to-[#6bb6c7] rounded-full opacity-35"></div>
              </div>
              <CardHeader>
                <div className="text-sm text-[#4a90a4] font-medium mb-2">{currentContent.blog.post2.date}</div>
                <CardTitle className="text-xl text-[#1e3a5f]">{currentContent.blog.post2.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base text-gray-600">
                  {currentContent.blog.post2.excerpt}
                </CardDescription>
              </CardContent>
            </Card>
          </div>
